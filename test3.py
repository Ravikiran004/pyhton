...
'''
Name:- Ravikiran Avinash Khilari
TY Comp 
'''
...
df1=df.rename(columns={'khilari':'KHILARI'})
df1['KHILARI']
##############################################################

#Q2. Convert your column into list
df2=df1['KHILARI'].tolist()
df2
...
sns.countplot(x='KHILARI',data=df1)
...
df
df2=df.index[df['Name']=='Khilari_Ravikiran']
df[29:30].max()
